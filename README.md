...
Нагрузочные сетевые методы (TCP/UDP/HTTP/SYN/ICMP/slowloris) и отчёты.
...
## Установка
- Клонируйте репозиторий: git clone https://github.com/BengaminButton/xillen-network-attack.git
- Перейдите в каталог: cd xillen-network-attack
